        ...
        <footer className={classes.root}>
            ...
            <Grid className={classes.grid} container>
                ...
                <Grid className={classes.listItem} item xs={12} sm={6} md={3}>
                    ...
                    <ExternalLink
                        href="https://www.facebook.com/afteracademy"
                        name="AfterAcademy"
                    />
                    <br />
                    <ExternalLink
                        href="https://www.facebook.com/mindorks.nextgen"
                        name="MindOrks"
                    />
                    <br />
                    <ExternalLink
                    ...
                    <br />
                    <ExternalLink
                        href="https://www.linkedin.com/in/janishar-ali"
                        name="Janishar Ali"
                    />
                </Grid>
                <Grid className={classes.listItem} item xs={12} sm={6} md={3}>
